...
function addBook() {
    ...
    const authorName = document.getElementById('authorName').value; // This will retrieve Author's name

    // Create a JSON object with book data
    const bookData = {
        title: bookTitle,
        publication_year: publicationYear,
        author: authorName // Including author name to the data sent to the server
    };
